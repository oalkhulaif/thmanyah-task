        ...
        >
          ...
          {/* Search Results */}
            {searchResults.length > 0 && (
                <div className="absolute top-full mt-2 w-full max-w-[500px] bg-[#F6F4EE] border shadow-md rounded-lg p-[8px] z-50"
                    style={{
                ...
                <div 
                    ...
                    ${index !== searchResults.length - 1 ? "border-b" : ""} hover:bg-gray-200`}
